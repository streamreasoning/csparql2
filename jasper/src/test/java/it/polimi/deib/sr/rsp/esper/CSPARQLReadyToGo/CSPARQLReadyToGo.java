package it.polimi.deib.sr.rsp.esper.CSPARQLReadyToGo;
...
import it.polimi.deib.sr.rsp.esper.CSPARQLReadyToGo.streams.LBSMARDFStreamTestGenerator;
...
public class CSPARQLReadyToGo {
    ...
    public static void main(String[] args) throws InterruptedException, IOException, ConfigurationException {
        ...
        int key = HOW_MANY_USERS_LIKE_THE_SAME_OBJ;
